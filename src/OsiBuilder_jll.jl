...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OsiBuilder_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("bbbc0f9a-0fea-5019-b319-2e05a2e52c5a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OsiBuilder", artifacts_toml) for e in artifacts["OsiBuilder"]]
...
if best_platform === nothing
    @debug("Unable to load OsiBuilder; unsupported platform $(triplet(platform_key_abi()))")
else
